    ...
    tags$div(id = "body-row",
      ...
      tags$div(id = "main-content",
          ...
          tags$div(class = "panel-grid cols-2",
            tags$div(class = "panel", id = "panel_bipartite_net",
              tags$div(class = "panel-header",
                ...
                tags$span(class = "placeholder-badge", "PLACEHOLDER_001")
              ),
              tags$div(class = "panel-body",
                # PLACEHOLDER_001 — Stage 3: replace with plotOutput("bipartiteNet")
                uiOutput("bipartiteNetPlaceholder")
              )
            ),
            tags$div(class = "panel", id = "panel_layout_vis",
              tags$div(class = "panel-header",
                tags$h3("FR Layout Preview"),
                tags$span(class = "placeholder-badge", "PLACEHOLDER_002")
              ),
              tags$div(class = "panel-body",
                # PLACEHOLDER_002 — Stage 3: replace with plotOutput("layoutVis")
                uiOutput("layoutVisPlaceholder")
              )
            )
          ),
        ...
        tags$div(id = "tab-coaffiliation", class = "tab-pane",
          ...
          tags$div(class = "panel-grid cols-2",
            # PLACEHOLDER_003 — Tier C
            tags$div(class = "panel", id = "panel_coaff_net",
              tags$div(class = "panel-header",
                tags$h3("Coaffiliation Network (Committees)"),
                tags$span(class = "placeholder-badge", "PLACEHOLDER_003")
              ),
              tags$div(class = "panel-body",
                uiOutput("coaffNetPlaceholder")
              )
            ),
            ...
            tags$div(class = "panel", id = "panel_isolates",
              tags$div(class = "panel-header",
                tags$h3("Isolates Analysis"), fake_badge("FAKE_002")
              ),
              tags$div(class = "panel-body",
                callout_box(
          ...
          tags$div(class = "panel",
            tags$div(class = "panel-header",
              tags$h3("Committees Sharing > 1 Member"), fake_badge("FAKE_002")
            ),
            tags$div(class = "panel-body",
        ...
        tags$div(id = "tab-centrality", class = "tab-pane",
          ...
          tags$div(class = "panel", id = "panel_centrality_dist",
            tags$div(class = "panel-header",
              tags$h3("Degree Distribution"), fake_badge("FAKE_003")
            ),
            tags$div(class = "panel-body",
              callout_box(
              ...
              tags$div(class = "chart-wrap", style = "height:240px",
                tags$canvas(id = "degDensityChart")
              )
            )
          ),
          ...
          tags$div(class = "panel", id = "panel_centrality_table",
            tags$div(class = "panel-header",
              tags$h3("Top 10 Committees by Centrality"), fake_badge("FAKE_003")
            ),
            tags$div(class = "panel-body",
          ...
          tags$div(class = "panel",
            tags$div(class = "panel-header",
              tags$h3("Distance to Focal Node"), fake_badge("FAKE_003")
            ),
            tags$div(class = "panel-body",
              callout_box(
        ...
        tags$div(id = "tab-clustering", class = "tab-pane",
          ...
          tags$div(class = "panel-grid cols-2",
            ...
            tags$div(class = "panel", id = "panel_community_bar",
              tags$div(class = "panel-header",
                tags$h3("Community Sizes"), fake_badge("FAKE_004"),
            ...
            # Community network — Tier C: PLACEHOLDER_004
            tags$div(class = "panel",
              tags$div(class = "panel-header",
                tags$h3("Community Network"),
                tags$span(class = "placeholder-badge", "PLACEHOLDER_004")
              ),
              tags$div(class = "panel-body",
                uiOutput("communityNetPlaceholder")
              )
            )
          ),
          ...
          tags$div(class = "panel", id = "panel_community_stats",
            tags$div(class = "panel-header",
              tags$h3("Cluster Statistics (Fast-Greedy, k=3)"), fake_badge("FAKE_004")
            ),
            tags$div(class = "panel-body",
        ...
        tags$div(id = "tab-iteration", class = "tab-pane",
          ...
          tags$div(class = "panel",
            tags$div(class = "panel-header",
              tags$h3("Sub-graph Statistics by Geography"), fake_badge("FAKE_005")
            ),
            tags$div(class = "panel-body",
          ...
          tags$div(class = "panel",
            tags$div(class = "panel-header",
              tags$h3("Local Coaffiliation by Geography"), fake_badge("FAKE_005")
            ),
            tags$div(class = "panel-body",
              callout_box(
